...
function changeColour(color) {
  switch (color) {
    case 'green':
      colour = "rgba(0,164,82,1)";
      break;
    case 'blue':
      colour = "rgba(0,163,213,1)";
      break;
    case 'pink':
      colour = "rgba(226,164,213,1)";
      break;
    case 'purple':
      colour = "rgba(62,65,239,1)";
      break;
  }
}
...
function startGame() {
  snake = new Snake(colour, 5 * tailIncrease, startX, startY, [], [], 'right');
